  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-gradient-to-br from-blue-100 via-white to-blue-200 font-sans">
      <div className="w-full max-w-3xl mx-auto text-center">
        ...
        >
          <div className="bg-white/70 border-l-4 border-blue-400 rounded-xl shadow px-6 py-4 mb-6 max-w-2xl mx-auto">
            <span className="text-3xl text-blue-400 font-serif select-none">“</span>
            <p className="text-blue-700 italic text-base md:text-lg mt-2 mb-6 text-center">
              Hanya pendidikan yang bisa menyelamatkan masa depan, tanpa pendidikan Indonesia tak mungkin bertahan.
            </p>
            <div className="flex items-center justify-end gap-2 mt-4">
              <span className="text-blue-400 text-2xl font-serif select-none">”</span>
              <span className="text-blue-500 font-semibold text-right">- Najwa Shihab</span>
            </div>
          </div>
        </motion.div>
